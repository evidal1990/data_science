...
# 09. Crie um array de números negativos de -5 a -1.
array_creation_negative_numbers = np.array(range(-5, 0))
print(array_creation_negative_numbers)
print("---------------------------------------------------------")

# 10. Crie um array de 15 números, com 5 números por linha e 3 colunas.
